...
public class RegistPrintForm {
	...
	private String working_sonota;
	private String syokan;
	...
	public String getWorking_sonota() {
		return working_sonota;
	}
	public void setWorking_sonota(String working_sonota) {
		this.working_sonota = working_sonota;
	}
	public String getSyokan() {
		return syokan;
	}
	public void setSyokan(String syokan) {
		this.syokan = syokan;
	}
}
